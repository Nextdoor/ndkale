...
class SQSTestCase(unittest.TestCase):
    ...
    def test_create_queue(self):
        ...
        expected_low_queue = sqs_inst._sqs.Queue('https://queue.amazonaws.com/123456789012/LowPriorityTest1')
        expected_hi_queue = sqs_inst._sqs.Queue('https://queue.amazonaws.com/123456789012/HighPriorityTest2')
